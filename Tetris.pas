...
type
  ...
  private
    ...
    procedure CreateSshape(centerX,centerY:Single; rotation:TRotation);
    procedure CreateZshape(centerX,centerY:Single; rotation:TRotation);
...
begin
  ...
  theShape := CreateShape(TShape.T, 100,100, TRotation.R90);
...
procedure TFormTetrisGame.CreateZshape(centerX,centerY:Single; rotation:TRotation);
begin
  CreateBlock(Self, 100, 400, TAlphaColorRec.Red);
  CreateBlock(Self, 130, 400, TAlphaColorRec.Red);
  CreateBlock(Self, 130, 370, TAlphaColorRec.Red);
  CreateBlock(Self, 160, 370, TAlphaColorRec.Red);
end;

procedure TFormTetrisGame.CreateSshape(centerX,centerY:Single; rotation:TRotation);
begin
  CreateBlock(Self, 260, 400, TAlphaColorRec.Purple);
  CreateBlock(Self, 230, 400, TAlphaColorRec.Purple);
  CreateBlock(Self, 230, 370, TAlphaColorRec.Purple);
  CreateBlock(Self, 200, 370, TAlphaColorRec.Purple);
end;
